            ...
            <div className=" w-[25%] h-full px-10 py-7 gap-5 flex flex-col items-start">
                ...
                <div className=" flex items-center w-full">
                    <div className={` relative w-16 h-16 flex justify-center items-center border border-muted-foreground transition-all duration-300 overflow-hidden`} onMouseEnter={() => {
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={` z-10 h-6 fill-primary transition-all duration-300 ${social1Status===true?" fill-background":""}`}><path d="M13 9H17.5L17 11H13V20H11V11H7V9H11V7.12777C11 5.34473 11.1857 4.69816 11.5343 4.04631C11.8829 3.39446 12.3945 2.88288 13.0463 2.53427C13.6982 2.18565 14.3447 2 16.1278 2C16.6498 2 17.1072 2.05 17.5 2.15V4H16.1278C14.8041 4 14.401 4.07784 13.9895 4.29789C13.6862 4.46011 13.4601 4.68619 13.2979 4.98951C13.0778 5.40096 13 5.80407 13 7.12777V9Z"></path></svg>
                    ...
                    <div className={` relative w-16 h-16 flex justify-center items-center border border-muted-foreground transition-all duration-300 overflow-hidden`} onMouseEnter={() => {
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={` z-10 h-6 fill-primary transition-all duration-300 ${social2Status===true?"fill-background":""}`}><path d="M8 2H1L9.26086 13.0145L1.44995 21.9999H4.09998L10.4883 14.651L16 22H23L14.3917 10.5223L21.8001 2H19.1501L13.1643 8.88578L8 2ZM17 20L5 4H7L19 20H17Z"></path></svg>
                    ...
                    <div className={` relative w-16 h-16 flex justify-center items-center border border-muted-foreground transition-all duration-300 overflow-hidden`} onMouseEnter={() => {
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={` z-10 h-6 fill-primary transition-all duration-300 ${social4Status===true?"fill-background":""}`}><path d="M12.2439 4C12.778 4.00294 14.1143 4.01586 15.5341 4.07273L16.0375 4.09468C17.467 4.16236 18.8953 4.27798 19.6037 4.4755C20.5486 4.74095 21.2913 5.5155 21.5423 6.49732C21.942 8.05641 21.992 11.0994 21.9982 11.8358L21.9991 11.9884L21.9991 11.9991C21.9991 11.9991 21.9991 12.0028 21.9991 12.0099L21.9982 12.1625C21.992 12.8989 21.942 15.9419 21.5423 17.501C21.2878 18.4864 20.5451 19.261 19.6037 19.5228C18.8953 19.7203 17.467 19.8359 16.0375 19.9036L15.5341 19.9255C14.1143 19.9824 12.778 19.9953 12.2439 19.9983L12.0095 19.9991L11.9991 19.9991C11.9991 19.9991 11.9956 19.9991 11.9887 19.9991L11.7545 19.9983C10.6241 19.9921 5.89772 19.941 4.39451 19.5228C3.4496 19.2573 2.70692 18.4828 2.45587 17.501C2.0562 15.9419 2.00624 12.8989 2 12.1625V11.8358C2.00624 11.0994 2.0562 8.05641 2.45587 6.49732C2.7104 5.51186 3.45308 4.73732 4.39451 4.4755C5.89772 4.05723 10.6241 4.00622 11.7545 4H12.2439ZM9.99911 8.49914V15.4991L15.9991 11.9991L9.99911 8.49914Z"></path></svg>
